...
public class BajaComponentes {
	...
	public BajaComponentes(TEmplea correcto, TEmplea datosIncorrecto, 
	...
	{
		TEmplea resultado = sa.borrarComponenteReparacion(correcto);
		assertTrue(resultado.getIdComponente() > 0);
	}
	@Test
	public void testDatosIncorrectos()
	{
		TEmplea resultado = sa.borrarComponenteReparacion(datosIncorrecto);
		assertTrue(resultado.getIdReparacion() == 0);
	}
	@Test
	public void testComponenteError()
	{
		TEmplea resultado = sa.borrarComponenteReparacion(componenteError);
		assertTrue(resultado.getIdReparacion() == -1);
	}
	@Test
	public void testReparacionError()
	{
		TEmplea resultado = sa.borrarComponenteReparacion(reparacionError);
